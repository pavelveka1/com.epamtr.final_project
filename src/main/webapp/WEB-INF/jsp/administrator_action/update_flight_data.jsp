...
<fmt:message bundle="${loc}" key="flight.update.ok"
	var="flight_update_ok" />
<fmt:message bundle="${loc}" key="flight.update.fail"
	var="flight_update_fail" />
				...
				<table>
					<tr>
						...
						<td><input type="text" name="current_city"
							placeholder="Current city" value="${selected_flight.currentCity}">
							<c:choose>
